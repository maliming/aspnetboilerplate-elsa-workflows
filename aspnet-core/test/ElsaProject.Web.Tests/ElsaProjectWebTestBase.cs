...
{
    public abstract class ElsaProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ElsaProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ElsaProjectWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<ElsaProjectDbContext> action)
        {
            using (var context = IocManager.Resolve<ElsaProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<ElsaProjectDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<ElsaProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ElsaProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ElsaProjectDbContext, Task<T>> func)
        {
            T result;
